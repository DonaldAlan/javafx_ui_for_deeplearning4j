 ...
 * @author Alex Black, Don Smith (with additions for UI)
...
public class GenerateTxtModelWithJavaFXUI {
    ...
    public static void main(String[] args ) throws Exception {
        ...
        TrainingListenerWithUI trainingListenerWithUI = TrainingListenerWithUI.initialize(learningRate, statsStorage); // das
		//Set up network configuration:
		MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
			.seed(12345)
			.l2(0.0001)
            .weightInit(WeightInit.XAVIER)
            .updater(new Adam(UILinkedLearningSchedule.getInstance(learningRate)))  // das
			.list()
